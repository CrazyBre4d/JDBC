...
public abstract class AbstractRepository<T> {
    ...
    private static final String dbCommand1 = "SELECT * FROM %s WHERE loginn = ? and is_ordered = 0";
    ...
    public List<T> getForUser(String user) {
        List<T> entities = new ArrayList<>();
        String query = String.format(dbCommand1, getTableName());
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
